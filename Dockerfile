...
RUN --mount=from=ghcr.io/sigstore/cosign/cosign:v3.1.2@sha256:d91bc4e7e95e8d2f549c747a72dc174f90579e410a1695f57f686674f84ce849,source=/ko-app/cosign,target=/usr/bin/cosign \
